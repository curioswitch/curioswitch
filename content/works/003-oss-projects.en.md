...
CurioStack is a full-stack development kit for building web applications
quickly.
It covers project structure, API and frontend templates, CI/CD, GCP
configuration, and security, providing an environment where developers can
focus on implementation right away.
...
We continue to share and improve these projects in the hope that they will be
useful in development environments like these.
